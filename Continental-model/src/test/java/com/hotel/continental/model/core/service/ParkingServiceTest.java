...
import com.hotel.continental.model.core.service.ParkingHistoryService;
import com.hotel.continental.model.core.service.ParkingService;
...
class ParkingServiceTest {
    ...
    private static Stream<Arguments> parkingExitTestData() {
        return Stream.of(
                ...
                //endregion
                //region Test case 3: Booking not found
                Arguments.of(
                        "Booking not found",
                        Map.of(BookingDao.BOOKINGID, 1, ParkingDao.PARKING_ID, 1),
                        Extras.createEntityResult(
                ...
                //endregion
                //region Test case 4: Not in parking
                Arguments.of(
                        "Not in parking",
                        Map.of(BookingDao.BOOKINGID, 1, ParkingDao.PARKING_ID, 1),
                        Extras.createEntityResult(
